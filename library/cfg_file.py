...
---
module: cfg_file
short_description: Tweak settings in CFG files
extends_documentation_fragment: files
description:
     - Value assigment using ':' symbol
...
def main():
    ...
    (changed, backup_file, diff, msg) = do_ini(module, path, section, option, value, state, backup, create, allow_no_value)
